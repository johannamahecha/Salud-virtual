...
<table width="1807" height="1030" border="0" align="center">
  ...
  <tr bordercolor="#0099FF">
    <td align="center" bgcolor="#FFFFFF" class="registro"><form id="form2" name="form2" method="post" action="">
	  ...
	  mysqli_query($db, "UPDATE registro SET Identificacion ='$Ident', Nombre ='$Nom', Apellidos ='$Ape', Tipocancer ='$Tipoca',  Telefono ='$Tel',  Fechanacimiento ='$Fechanaci', fk_Genero ='$Gene' WHERE Id_registro = '$Idd'") or die(mysqli_error($db));
	  
	  echo "Datos enviados correctamente";
	  ?>
        </p>
        <p align="center"><a href="Administrador.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image1','','img_regresar1.png',1)"><img src="img_regresar.png" name="Image1" width="68" height="52" border="0" id="Image1" /></a> </p>
        <p align="center">
          <label></label>
        </p>
        </form>
