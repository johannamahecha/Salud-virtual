      ...
      <form id="form2" name="form2" method="post" action="Negocio_consultar_Identificacion1.php"></p>
          <table width="265" border="1" bordercolor="03A9F4" align="center">
            ...
            <tr>
              ...
              <td><div align="center"><?php echo $AApellidos;?>
                    <input name="Ape" type="hidden" id="Ape" value="<?php echo $AApellidos;?>" />
              </div>                <label></label></td>
            </tr>
            <tr>
              <td class="registro">TipodeC&aacute;ncer</td> 
              <td><label>
                <input name="Tipoca" type="text" id="Tipoca" value="<?php echo $TTipocancer;?>" />
              </label></td>
            </tr>
            <tr>
            ...
            <tr>
              <td class="registro">FechaNacimiento</td> 
              <td><label>
                <input name="Fechanaci" type="date" id="Fechanaci" value="<?php echo $FFechanacimiento;?>" />
              </label></td>
            </tr>
            <tr>
              <td class="registro">Genero</td>
              <td><select name="Gene" id="Gene">
        ...
        <p>&nbsp;</p>
        <p><a href="Administrador.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image1','','img_regresar1.png',1)"><img src="img_regresar.png" name="Image1" width="65" height="52" border="0" id="Image1" /></a> </p>
      </form>
      <p align="center">
        <label></label>
      </p>
