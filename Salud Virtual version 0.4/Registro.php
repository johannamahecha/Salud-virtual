...
<table width="1807" height="1030" border="0" align="center">
  ...
  <tr bordercolor="#0099FF">
    <td bgcolor="#FFFFFF"><form id="form2" name="form2" method="post" action="Registro1.php">
        ...
        <table width="523" height="735" border="0" align="center">
          <tr>
            <td width="262" height="68"><center>
              <span class="registro">Nombre:</span>
            </center> 
              <label>
              <center><input name="Nombre" type="text" id="Nombre" size="35" pattern="[a-zñ áéíóú]+" required /></center>
            </label></td>
            <td width="251"><center>
              <span class="registro">Apellidos:</span>
            </center> 
              <label>
              <center><input name="Apellidos" type="text" id="Apellidos" size="35" pattern="[a-zñ áéíóú]+" required /> 
              </center>
            </label></td>
          </tr>
          <tr>
            <td colspan="2" class="registro"><center>
              ...
              <p>
                <label></label>
                <label>
                <input name="Tipocancer" type="text" id="Tipocancer" size="76" pattern="[a-zñ áéíóú]+" required />
                </label>
              </p>
            </center>
            <p>
          ...
          <tr>
            <td height="50" colspan="2" class="registro"><p align="center">Genero </p>
              <p align="center">
