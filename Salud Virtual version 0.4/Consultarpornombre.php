...
<table width="1807" height="1030" border="0" align="center">
  ...
  <tr bordercolor="#0099FF">
    <td bgcolor="#FFFFFF"><form id="form2" name="form2" method="post" action="Negocio_consultar_nombre.php">
        <p align="center"><span class="registro">Digite el Nombre </span></p>
        <p align="center">
          <label>
          <input name="Nombre" type="text" id="Nombre" size="30" pattern="[a-zñ áéíóú]+" required />
          </label>
        </p>
        <p align="center">
          <label>
