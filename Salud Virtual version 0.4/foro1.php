	...
	<form action="Contactenos1.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
	  ...
	  <p>
        ...
        <div align="center">
          ...
          <p><a href="formulario1.php" class="Login">Opinar</a></p>
          <p><a href="Administrador.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image1','','img_regresar1.png',1)"><img src="img_regresar.png" name="Image1" width="72" height="49" border="0" id="Image1" /></a></p>
        </div>
        <center></center>
