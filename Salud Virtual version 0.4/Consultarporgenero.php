...
<table width="1807" height="1030" border="0" align="center">
  ...
  <tr bordercolor="#0099FF">
    <td bgcolor="#FFFFFF"><form id="form2" name="form2" method="post" action="Negocio_consultar_genero.php">
        <p align="center"><span class="registro">Seleccione el Genero </span></p>
        <p align="center">
          <label></label>
          <label>
