	...
	<form action="Contactenos1.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
	  ...
	  <p>
        ...
        <div align="center">
          ...
          <p><a href="formularioEntidades.php" class="Login">Publicar</a></p>
          <p><a href="AdministradorEntidades.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image1','','img_regresar1.png',1)"><img src="img_regresar.png" name="Image1" width="59" height="46" border="0" id="Image1" /></a></p>
        </div>
        <center></center>
