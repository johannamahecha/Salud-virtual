...
<table width="1807" height="1030" border="0" align="center">
  ...
  <tr bordercolor="#0099FF">
    <td bgcolor="#FFFFFF"><form id="form2" name="form2" method="post" action="Negocio_consultar_Identificacion.php">
        <p align="center"><span class="registro">Digite la identificaci&oacute;n </span></p>
        <p align="center">
          <label>
          <input name="Identificacion" type="text" id="Identificacion" size="30" pattern="[0-9]+" required />
          </label>
        </p>
        <p align="center">
          <label>
        ...
        <p align="center" class="registro"><a href="Index.php"></a></p>
        <p align="center">&nbsp;</p>
        </form>
      <p align="center">&nbsp;</p>
